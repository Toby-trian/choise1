  ...
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        ...
        <div class="tile-body">
          <form action="<?php echo base_url('Administrator/Data_ujian/tambahdata_holland') ?>" method="post">
          ...
          <a style="margin-top: 15px" href="<?php echo base_url('Administrator/Data_ujian/ujian_holland') ?>" class="btn btn-secondary"> Cancel</a>
        </form>
      </div>
