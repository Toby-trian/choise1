...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-clipboard"></i> Ujian IST</h1>
    </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        <a href="<?php echo base_url('Administrator/Data_ujian/tambahdata_ist') ?>" class="btn btn-primary" style="margin-bottom: 2%;">Tambah Data</a>
        <div id="notifikasi">
                    ...
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <a href="<?php echo base_url('Administrator/Data_ujian/hapus_ujian_ist/'.$key['id_ujian']) ?>" title="Hapus Data"><button type="button" class="btn btn-danger" style="margin-left: 170px;"><i class="fa fa-trash"></i> Hapus</button></a>
                  ...
                  <div class="modal fade" id="myModal<?php echo $modal ?>" role="dialog">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <a href="<?php echo base_url('Administrator/Data_ujian/hentikan_ujian_ist/'.$key['id_ujian']) ?>" title="Hentikan ujian"><button type="button" class="btn btn-dark" style="margin-left: 170px;"><i class="fa fa-stop text-danger"></i> Hentikan ujian</button></a>
                        </div>
                      </div>
                    </div>
                  </div> 
