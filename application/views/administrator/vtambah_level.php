  ...
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        ...
        <div class="tile-body">
          <form action="<?php echo base_url('Administrator/Welcome/tambahdata') ?>" method="post">
            <div class="form-group">
              <label class="control-label">Nama Level</label>
              <input class="form-control" name="nama_level" type="text" placeholder="Enter full name">
            </div>
