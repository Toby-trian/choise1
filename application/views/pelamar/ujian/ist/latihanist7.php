...
var x = setInterval(function() {
  ...
  if (distance < 0) {
    ...
    alert('Waktu latian subtes 7 sudah berakhir, selamat mengerjakan subtes 7');
    window.location.href = '<?php echo base_url('Pelamar/Ujian/start_ujian_ist7/'.$idUjian.'/117'); ?>';
