...
<?php $id_ujian = $this->session->userdata('ses_ujian'); ?>
	...
	<a href="<?php echo base_url('Pelamar/Ujian/frame_ujian_sub2/1/1') ?>" style="color: <?php echo $warnaText ?>"><b>1</b></a>
</div>
...
style="background-color: <?php echo $warna ?>; margin: 5px; padding: 10px; border-radius: 5px">
<a href="<?php  echo base_url('Pelamar/Ujian/frame_ujian_sub2/1/2') ?>" style="color: <?php echo $warnaText ?>"><b>2</b></a>
</div>
...
style="background-color: <?php echo $warna ?>;  margin: 5px; padding: 10px; border-radius: 5px">
<a href="<?php  echo base_url('Pelamar/Ujian/frame_ujian_sub2/1/3') ?>" style="color: <?php echo $warnaText ?>"><b>3</b></a>
</div>
...
style="background-color: <?php echo $warna ?>;  margin: 5px; padding: 10px; border-radius: 5px">
<a href="<?php  echo base_url('Pelamar/Ujian/frame_ujian_sub2/1/4') ?>" style="color: <?php echo $warnaText ?>"><b>4</b></a>
</div>
...
<a href="<?php echo base_url('Pelamar/Ujian/frame_ujian_sub2/1/5') ?>" type="submit" style="background-color: $warna;color: <?php echo $warnaText ?>"><b>5</b></a>
</div>
...
style="background-color: <?php echo $warna ?>;  margin: 5px; padding: 10px; border-radius: 5px">
<a href="<?php  echo base_url('Pelamar/Ujian/frame_ujian_sub2/1/6') ?>" style="color: <?php echo $warnaText ?>"><b>6</b></a>
</div>
...
style="background-color: <?php echo $warna ?>;  margin: 5px; padding: 10px; border-radius: 5px">
<a href="<?php  echo base_url('Pelamar/Ujian/frame_ujian_sub2/1/7') ?>" style="color: <?php echo $warnaText ?>"><b>7</b></a>
</div>
...
<a href="<?php  echo base_url('Pelamar/Ujian/frame_ujian_sub2/1/8') ?>" style="color: <?php echo $warnaText ?>"><b>8</b></a>
</div>
...
style="background-color: #f1f1f1;  margin: 5px; padding: 10px; border-radius: 5px">
<a href="<?php  echo base_url('Pelamar/Ujian/frame_ujian_sub2/1/9') ?>" style="color: <?php echo $warnaText ?>"><b>9</b></a>
</div>
...
style="background-color: #f1f1f1;  margin: 5px; padding: 10px; border-radius: 5px">
<a href="<?php  echo base_url('Pelamar/Ujian/frame_ujian_sub2/1/10') ?>" style="color: <?php echo $warnaText ?>"><b>10</b></a>
</div>
...
style="background-color: #f1f1f1;  margin: 5px; padding: 10px; border-radius: 5px">
<a href="<?php  echo base_url('Pelamar/Ujian/frame_ujian_sub2/1/11') ?>" style="color: <?php echo $warnaText ?>"><b>11</b></a>
</div>
...
style="background-color: #f1f1f1;  margin: 5px; padding: 10px; border-radius: 5px">
<a href="<?php  echo base_url('Pelamar/Ujian/frame_ujian_sub2/1/12') ?>" style="color: <?php echo $warnaText ?>"><b>12</b></a>
</div>
...
style="background-color: <?php echo $warna ?>;  margin: 5px; padding: 10px; border-radius: 5px">
<a href="<?php  echo base_url('Pelamar/Ujian/frame_ujian_sub2/1/13') ?>" style="color: <?php echo $warnaText ?>"><b>13</b></a>
</div>
...
style="background-color: <?php echo $warna ?>;  margin: 5px; padding: 10px; border-radius: 5px">
<a href="<?php  echo base_url('Pelamar/Ujian/frame_ujian_sub2/1/14') ?>" style="color: <?php echo $warnaText ?>"><b>14</b></a>
</div>
</div>
