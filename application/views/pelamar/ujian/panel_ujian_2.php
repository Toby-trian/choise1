...
?>
	...
	<a href="<?php echo base_url('Pelamar/Ujian/frame_ujian_sub2/'.$id_ujian.'/'.'1') ?>" style="color: <?php echo $warnaText ?>"><b>1</b></a>
</div>
...
style="background-color: <?php echo $warna ?>; margin: 5px; padding: 10px; border-radius: 5px">
<a href="<?php  echo base_url('Pelamar/Ujian/frame_ujian_sub2/'.$id_ujian.'/'.'2') ?>" style="color: <?php echo $warnaText ?>"><b>2</b></a>
</div>
...
style="background-color: <?php echo $warna ?>;  margin: 5px; padding: 10px; border-radius: 5px">
<a href="<?php  echo base_url('Pelamar/Ujian/frame_ujian_sub2/'.$id_ujian.'/'.'3') ?>" style="color: <?php echo $warnaText ?>"><b>3</b></a>
</div>
...
style="background-color: <?php echo $warna ?>;  margin: 5px; padding: 10px; border-radius: 5px">
<a href="<?php  echo base_url('Pelamar/Ujian/frame_ujian_sub2/'.$id_ujian.'/'.'4') ?>" style="color: <?php echo $warnaText ?>"><b>4</b></a>
</div>
...
<a href="<?php echo base_url('Pelamar/Ujian/frame_ujian_sub2/'.$id_ujian.'/'.'5') ?>" type="submit" style="background-color: $warna;color: <?php echo $warnaText ?>"><b>5</b></a>
</div>
...
style="background-color: <?php echo $warna ?>;  margin: 5px; padding: 10px; border-radius: 5px">
<a href="<?php  echo base_url('Pelamar/Ujian/frame_ujian_sub2/'.$id_ujian.'/'.'6') ?>" style="color: <?php echo $warnaText ?>"><b>6</b></a>
</div>
...
style="background-color: <?php echo $warna ?>;  margin: 5px; padding: 10px; border-radius: 5px">
<a href="<?php  echo base_url('Pelamar/Ujian/frame_ujian_sub2/'.$id_ujian.'/'.'7') ?>" style="color: <?php echo $warnaText ?>"><b>7</b></a>
</div>
...
style="background-color: <?php echo $warna ?>;  margin: 5px; padding: 10px; border-radius: 5px">
<a href="<?php  echo base_url('Pelamar/Ujian/frame_ujian_sub2/'.$id_ujian.'/'.'13') ?>" style="color: <?php echo $warnaText ?>"><b>13</b></a>
</div>
...
style="background-color: <?php echo $warna ?>;  margin: 5px; padding: 10px; border-radius: 5px">
<a href="<?php  echo base_url('Pelamar/Ujian/frame_ujian_sub2/'.$id_ujian.'/'.'14') ?>" style="color: <?php echo $warnaText ?>"><b>14</b></a>
</div>
</div>
