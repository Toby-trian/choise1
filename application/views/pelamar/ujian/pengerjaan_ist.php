...
<div class="col-sm-12 main">
	...
	?>
	<iframe  id="frame" src="<?php echo base_url('Pelamar/Ujian/frame_ujian_ist/'.$id_ujian.'/'.$nomor ) ?>" width="100%" onload="this.style.height=this.contentDocument.body.scrollHeight +'px';"  frameborder="0">Browser Anda Tidak Mendukung  Iframe, Silahkan Perbaharui Browser Anda.</iframe>
...
var x = setInterval(function() {
  ...
  if (distance < 0) {
  	...
  	window.location.href = '<?php echo base_url('Pelamar/Ujian/latihan_ist2/'.$id_ujian); ?>';
