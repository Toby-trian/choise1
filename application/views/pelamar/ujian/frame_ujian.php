	...
	<div class="col-md-7 col-sm-12" style="margin-bottom: 5px;">
		<div class="col-sm-12">
			...
			<div class="form-check col-sm-2 text-center" style="margin-top: 5px;">
				...
				<input class="form-check-input" type="radio" name="jawaban" value="e">
				<center>
			...
			<div class="form-check col-sm-2 text-center" style="margin-top: 5px;">
				...
				<input class="form-check-input" type="radio" name="jawaban" value="f">
				<center>
		...
		<center>
			<div class="baten">
				...
				<a href="#" class="btn btn-primary"><i class="fa fa-arrow-circle-left"></i> Sebelumnya</a>
				<a href="#" class="btn btn-primary">Confirm</a>
				<a href="#" class="btn btn-primary">Selesai <i class="fa fa-arrow-circle-right"></i></a>
			</div>
		</center>
	</div>
	<?php 
