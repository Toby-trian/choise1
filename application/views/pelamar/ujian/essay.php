...
foreach ($essay->result() as $key_uEssay) {

	$timeEssay = $key_uEssay->waktu_akhir;
		...
		<div class="form-row">
			...
			<form action="<?php echo base_url("Pelamar/Ujian/jawaban_essay/") ?>" method="post">
				...
				<div class="form-group">
					...
					<label>1. Jelaskan secara singkat terkait pemahaman anda mengenai gambaran dari Deskripsi Pekerjaan pada posisi yang anda lamar ?</label>
				...
				<div class="form-group">
					...
					<label>2. Jelaskan permasalahan internal maupun lapangan yang sering muncul pada posisi jabatan yang anda lamar sekaligus bagaimana solusinya ??
				...
				<div class="form-group">
					...
					<label>3. Apa yang anda sukai pada tugas dari pekerjaan yang anda lamar saat ini ? Kemudian jelaskan mengapa ?
				...
				<div class="form-group">
					...
					<label>4. Sebutkan kompetensi teknis dan karakter apa yang anda miliki sesuai dengan peran dan wewenang pada posisi jabatan yang anda lamar saat ini ? 
				...
				<label>5. Jawablah dengan singkat mengenai pertanyaan ini :
					</label>
				...
				<br>
					...
					<label>a. Apa yang anda maknai tentang integritas?
					</label>
				...
				<div class="form-group">
					...
					<label>b. Bagaimana cara anda menciptakan situasi kerja yang mampu menampilkan integritas dan profesionalitas kerja?
					</label>
				...
				<div class="form-group">
					...
					<label>c. Bagaimana cara anda untuk mengingatkan/mengajak rekan kerja maupun bawahan dalam bertindak sesuai dengan nilai, norma dan etika perusahaan?					</label>
				...
				<div class="form-group">
					...
					<label>6. Apakah anda pernah terlibat dalam sebuah tim kerja? Ceritakan situasi/kejadian, sekaligus peran apa yang anda lakukan dalam kegiatan tersebut?
				...
				<div class="form-group">
					...
					<label>7. Dalam mencapai target atas deskripsi pekerjaan yang dituntut pada posisi jabatan yang anda lamar saat ini, sebutkan langkah apa saja yang akan anda lakukan untuk memenuhi tuntutan perusahaan atas kinerja anda? 
				...
				<div class="form-group">
					...
					<label>8. Menurut pengalaman anda, apakah anda pernah memimpin sebuah tim kerja/kelompok. Apabila iya, silahkan berikan penjelasan singkat mengenai tugas yang anda miliki pada posisi tersebut sekaligus bagaimana cara anda untuk mengarahkan tim sekaligus mengevaluasi setiap progress kerja dan permasalahan yang timbul? 
...
<script type="text/javascript">
  ...
  var countDownDate = new Date("<?php echo $timeEssay ?>").getTime();
