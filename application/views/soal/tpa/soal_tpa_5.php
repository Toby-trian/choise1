    ...
    <div class="col-md-12">
      <div class="tile">
        ...
        <div class="tile-body">
          ...
          <li class="active"><a data-toggle="tab"><b>Soal Seksi 5</b></a></li>
        </ul>
              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="<?php echo base_url('Soal/Soal_tpa/tambahdata_5') ?>" method="post">
                  ...
                  foreach ($tpa5 as $key_s5) { ?>
                    ...
                    <div class="modal fade" id="modalEdit<?php echo $modal ?>" role="dialog">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="<?php echo base_url('Soal/Soal_tpa/editdata_5/'.$key_s5['id_soal_tpa']) ?>" method="post">
                              <input type="hidden" name="id_soal_tpa" value="<?php echo $key_s5['id_soal_tpa'] ?>">
                              <div class="form-group">
                                <label class="control-label">Soal</label>
                                <input type="text" name="soal" class="form-control" value="<?php echo $key_s5['soal'] ?>">
                              </div>
                              <div class="form-group">
                                <label class="control-label">Opsi A</label>
                                <input type="text" name="opsi_a" class="form-control" value="<?php echo $key_s5['opsi_a'] ?>">
                              </div>
                              <div class="form-group">
                                <label class="control-label">Opsi B</label>
                                <input type="text" name="opsi_b" class="form-control" value="<?php echo $key_s5['opsi_b'] ?>">
                              </div>
                              <div class="form-group">
                                <label class="control-label">Opsi C</label>
                                <input type="text" name="opsi_c" class="form-control" value="<?php echo $key_s5['opsi_c'] ?>">
                              </div>
                              <div class="form-group">
                                <label class="control-label">Opsi D</label>
                                <input type="text" name="opsi_d" class="form-control" value="<?php echo $key_s5['opsi_d'] ?>">
                              </div>
                              <div class="form-group">
                                <label class="control-label">Opsi E</label>
                                <input type="text" name="opsi_e" class="form-control" value="<?php echo $key_s5['opsi_e'] ?>">
                              </div>
                              <div class="form-group">
                                <label class="control-label">Jawaban</label>
                                <input type="text" name="jawaban" class="form-control" value="<?php echo $key_s5['jawaban'] ?>">
                              </div>
                            </div>
                            <div class="modal-footer">
                    ...
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <p>Ingin hapus pernyataan ini? <b><?php echo $key_s5['soal'] ?></b></p>
                        </div>
                        <div class="modal-footer">
                          <a href="<?php echo base_url('Soal/Soal_tpa/hapus_5/'.$key_s5['id_soal_tpa']) ?>" title="Hapus Data"><button type="button" class="btn btn-danger">Hapus <i class="fa fa-trash"></i></button></a>
                        </div>
                      </div>
                    </div>
                  </div> 
                    ...
                    <tr>
                      <td><?php echo $no++ ?></td>
                      <td><?php echo $key_s5['soal'] ?></td>
                      <td><?php echo $key_s5['opsi_a'] ?></td>
                      <td><?php echo $key_s5['opsi_b'] ?></td>
                      <td><?php echo $key_s5['opsi_c'] ?></td>
                      <td><?php echo $key_s5['opsi_d'] ?></td>
                      <td><?php echo $key_s5['opsi_e'] ?></td>
                      <td><b><?php echo $key_s5['jawaban'] ?></b></td>
                      <td>
