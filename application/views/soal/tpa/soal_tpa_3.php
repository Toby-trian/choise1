    ...
    <div class="col-md-12">
      <div class="tile">
        ...
        <div class="tile-body">
          ...
          <li class="active"><a data-toggle="tab"><b>Soal Seksi 3</b></a></li>
        </ul>
                  ...
                  foreach ($tpa3 as $key_s3) { ?>
                    ...
                    <div class="modal fade" id="modalEdit<?php echo $modal ?>" role="dialog">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="<?php echo base_url('Soal/Soal_tpa/editdata_3/'.$key_s3['id_soal_tpa']) ?>" method="post">
                              <input type="hidden" name="id_soal_tpa" value="<?php echo $key_s3['id_soal_tpa'] ?>">
                              <div class="form-group">
                                <label class="control-label">Soal</label>
                                <input type="text" name="soal" class="form-control" value="<?php echo $key_s3['soal'] ?>">
                              </div>
                              <div class="form-group">
                                <label class="control-label">Opsi A</label>
                    ...
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <a href="<?php echo base_url('Soal/Soal_tpa/hapus_3/'.$key_s3['id_soal_tpa']) ?>" title="Hapus Data"><button type="button" class="btn btn-danger">Hapus <i class="fa fa-trash"></i></button></a>
                        </div>
                      </div>
                    </div>
                  </div> 
