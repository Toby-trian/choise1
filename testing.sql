...
--
-- Host: localhost
-- Generation Time: Apr 28, 2021 at 10:24 AM
...
CREATE TABLE `tb_data_jawaban_ist` (
  ...
  `jawaban_kunci` varchar(5) CHARACTER SET latin1 NOT NULL
...
INSERT INTO `tb_data_jawaban_ist` (`id_jawaban_ist`, `id_pelamar`, `id_lowongan`, `nomor_soal`, `id_ujian`, `subtes`, `jawaban`, `jawaban_kunci`) VALUES
(1, 2, 3, 1, 1, '1', 'C', 'D'),
(2, 1, 3, 1, 1, '1', 'C', 'D'),
(3, 1, 0, 2, 1, '1', 'C', 'C'),
(4, 1, 0, 3, 1, '1', 'E', 'D'),
...
INSERT INTO `tb_soal_ist` (`id_soal`, `nomor_soal`, `soal`, `opsi_a`, `opsi_b`, `opsi_c`, `opsi_d`, `opsi_e`, `jawaban`, `subtes`) VALUES
...
(63, 61, 'mawar - melati', '-', '-', '-', '-', '-', '-', '4'),
(64, 62, 'mata - telinga', '-', '-', '-', '-', '-', '-', '4'),
(65, 63, 'gula - intan', '-', '-', '-', '-', '-', '-', '4'),
(66, 64, 'hujan - salju', '-', '-', '-', '-', '-', '-', '4'),
(67, 65, 'pengantar surat - telepon', '-', '-', '-', '-', '-', '-', '4'),
(68, 66, 'kamera - kacamata', '-', '-', '-', '-', '-', '-', '4'),
(69, 67, 'lambung - usus', '-', '-', '-', '-', '-', '-', '4'),
(70, 68, 'banyak - sedikit', '-', '-', '-', '-', '-', '-', '4'),
(71, 69, 'telur - benih', '-', '-', '-', '-', '-', '-', '4'),
(72, 70, 'bendera - lencana', '-', '-', '-', '-', '-', '-', '4'),
(73, 0, '-', '-', '-', '-', '-', '-', '-', '4'),
(74, 72, 'ember - kantong', '-', '-', '-', '-', '-', '-', '4'),
(75, 73, 'awal - akhir', '-', '-', '-', '-', '-', '-', '4'),
(76, 74, 'kikir - boros', '-', '-', '-', '-', '-', '-', '4'),
(77, 75, 'penawaran - permintaan', '-', '-', '-', '-', '-', '-', '4'),
(78, 76, 'atas - bawah', '-', '-', '-', '-', '-', '-', '4');
...
(14, 'Intelegentcy Test ( CFIT )', '2021-04-27 10:49:16', '2021-04-27 11:16:16', '2021-04-27 10:49:16', '2021-04-27 10:53:16', '2021-04-27 10:53:16', '2021-04-27 10:57:16', '2021-04-27 10:57:16', '2021-04-27 10:59:16', '2021-04-27 10:59:16', '2021-04-27 11:04:16', '2021-04-27 11:04:16', '2021-04-27 11:06:16', '2021-04-27 11:06:16', '2021-04-27 11:10:16', '2021-04-27 11:10:16', '2021-04-27 11:12:16', '2021-04-27 11:12:16', '2021-04-27 11:16:16', 1950, 'admin', 'tersedia');
...
(1, 'Test Sikap Kerja', '2021-04-05 14:00:00', '2021-04-05 15:00:00', '');
...
INSERT INTO `tb_ujian_ist` (`id_ujian`, `nama_ujian`, `waktu_dimulai`, `waktu_berakhir`, `start_lat_sub1`, `end_lat_sub1`, `start_uji_sub1`, `end_uji_sub1`, `start_lat_sub2`, `end_lat_sub2`, `start_uji_sub2`, `end_uji_sub2`, `start_lat_sub3`, `end_lat_sub3`, `start_uji_sub3`, `end_uji_sub3`, `durasi`, `nama_pembuat`, `status`) VALUES
(49, 'Intelegency Test ( IST )', '2021-04-28 13:15:00', '2021-04-28 13:42:00', '2021-04-28 13:15:00', '2021-04-28 13:17:00', '2021-04-28 13:17:00', '2021-04-28 13:25:00', '2021-04-28 13:25:00', '2021-04-28 13:27:00', '2021-04-28 13:27:00', '2021-04-28 13:35:00', '2021-04-28 13:35:00', '2021-04-28 13:37:00', '2021-04-28 13:37:00', '2021-04-28 13:42:00', 1950, 'Administrator', 'tersedia');
...
(1, 'Tes Minat Kerja', '2021-03-25 16:35:00', '2021-03-25 16:45:00', 'tersedia');
...
--
ALTER TABLE `tb_data_jawaban_ist`
  MODIFY `id_jawaban_ist` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `tb_nilai_cfit`
  MODIFY `id_nilai_cfit` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tb_ujian`
  MODIFY `id_ujian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
